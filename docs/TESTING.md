...
| Experimental Apple TV | arm64 tvOS 17 core, corrected 221-chunk GMSE01 module, native app, layered artwork, and deterministic unsigned IPA pass local build/content audits; no Apple TV is paired with this Mac | Physical install, missing-data screen, title/gameplay, Metal/audio, Extended Gamepad, focus, disconnect/reconnect, sleep/wake, performance, thermals, save/readback, and 30-minute run |
