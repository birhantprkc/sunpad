...
struct SunPadControllerSlotChange {
  uintptr_t instance = 0;
  std::size_t slot = 0;
};

struct SunPadControllerReconcileResult {
  std::vector<SunPadControllerSlotChange> removed;
  std::vector<SunPadControllerSlotChange> assigned;
};
...
class SunPadControllerSlots {
 public:
  static constexpr std::size_t kMaxPlayers = 4;

  SunPadControllerReconcileResult Reconcile(
